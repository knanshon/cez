...
func Page() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"container\"><h2>API Explorer</h2><div id=\"api-method-selector-wrapper\" hx-get=\"/explorer/components/api-method-selector\" hx-trigger=\"load\" hx-target=\"this\" hx-swap=\"outerHTML\">Loading API methods...</div><div id=\"api-form-area\"></div><hr><h3>API Response:</h3><div id=\"api-response-viewer\" class=\"response-viewer\"><pre><code>(No response yet)</code></pre></div></div>")
			if templ_7745c5c3_Err != nil {
