...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/knanshon/cez/gen/api/greeter/v1"
	http "net/http"
	strings "strings"
)
...
var (
	greeterServiceServiceDescriptor     = v1.File_api_greeter_v1_service_proto.Services().ByName("GreeterService")
	greeterServiceGreetMethodDescriptor = greeterServiceServiceDescriptor.Methods().ByName("Greet")
)
...
func NewGreeterServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreeterServiceClient {
	...
	return &greeterServiceClient{
		greet: connect.NewClient[v1.GreetRequest, v1.GreetResponse](
			...
			connect.WithSchema(greeterServiceGreetMethodDescriptor),
